...
class ArcherC2(BaseRouter):
    ...
    def reboot(self, password):
        ...
        self.driverWait.until(EC.presence_of_element_located((By.ID, "menu_tools"))).click()
        time.sleep(2)

        rebootSubMenuItem = self.driverWait.until(EC.presence_of_element_located((By.ID, "menu_restart")))
        ...
        self.driverWait.until(EC.presence_of_element_located((By.ID, "button_reboot"))).click()
        time.sleep(1)
    ...
    def logOut(self):
        ...
        self.driverWait.until(EC.presence_of_element_located((By.ID, "menu_logout"))).click()

...
class ArcherC7(BaseRouter):
    ...
    def reboot(self, password):
        ...
        self.driverWait.until(EC.presence_of_element_located((By.ID, "a64"))).click()
        time.sleep(2)

        self.driverWait.until(EC.presence_of_element_located((By.ID, "a70"))).click()
        time.sleep(2)
        ...
        self.driverWait.until(EC.presence_of_element_located((By.ID, "reboot"))).click()
        time.sleep(1)
